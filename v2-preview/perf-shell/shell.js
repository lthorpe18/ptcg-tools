(function(){
  ...
  function sectionForUrl(input){
    ...
    if(path===base||path===`${base}/`||path===`${base}/index.html`)return 'home';
  ...
  function installChildBridge(frame){
    ...
    if(!doc||doc.documentElement.dataset.ptcgPerfShell==='1')return;
    doc.documentElement.dataset.ptcgPerfShell='1';
