...
function bind(){const host=document.getElementById('myTournamentsPanel');if(host)new MutationObserver(()=>setTimeout(enhance,0)).observe(host,{childList:true,subtree:true});window.addEventListener('ptcg:local-change',()=>setTimeout(enhance,30));setTimeout(enhance,100)}
