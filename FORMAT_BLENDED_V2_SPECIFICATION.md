...
**Status:** Product specification accepted on 7 September 2026. Checkpoints 1–4 are merged and owner-tested; Checkpoint 4's concise-Home follow-up is implemented for review. See `FORMAT_FOUNDATION_CHECKPOINT_1.md`, `META_FORMATS_CHECKPOINT_2.md`, `BLENDED_V2_CHECKPOINT_3.md` and `HOME_CHECKPOINT_4.md`. Checkpoint 5 has not begun.
...
| 4. Home | Shared Online-target prediction and existing format chip, essential status and shared explanation link. No layout redesign/shortcuts/badges | Home/Meta target, revision, share and weight parity; no silent fallback; no stale chart after format update | Cold/warm return, grouping, hero handoff, unavailable display, compact 390px. Stop |
