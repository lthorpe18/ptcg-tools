...
- `PTCG_TOOLS_MASTER.md` for the current product source of truth;
- `ROADMAP_HANDOFF_2026-09-07.md` for the current programme sequence and next-chat scope.

Do not use this dated handoff to begin Collection or choose the next development milestone.
